        ...
        <div>
            ...
            <section>
                ...
                <Codeblock
                    language="jsx"
                    // className="foo"
                >{`<Codeblock>const foo = "foo";</Codeblock>`}</Codeblock>
                <h4>Result:</h4>
            ...
            <section>
                <h3>Multiline</h3>
                <p>
                    For <Code>inline</Code>multiline strings you can use a
                    string literal. However, you will have to escape backticks
                    in the content.
                </p>
